...
module.exports.run = async (receivedMessage, args, Client) => {
  ...
  try{
    console.log("credits command ran!")
    await CreditsCommand(receivedMessage)
  }catch(err){
    console.log(err)
